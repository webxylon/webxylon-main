                ...
                >
                  ...
                  <div className="flex flex-col gap-6">
                    <h3 className="text-white">
                      They work in less time and I got my results in less time and work professionally
                    </h3>
                    <div className="flex flex-col gap-1">
                      <p className="text-white font-medium">NEERAJ SINGH NIRBAN</p>
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <h3 className="dark:text-dark_black text-2xl">
                      Clients recommend our technical services.
                    </h3>
                  </div>
                </motion.div>
              </div>
                ...
                >
                  <div className="flex flex-col gap-6">
                    ...
                    <h2 className="text-2xl lg:text-5xl">
                      “Webxylon brought our ideas to life with exceptional creativity and precision, exceeding expectations.”
                    </h2>
                  </div>
                  <div className="flex flex-col gap-1">
                    <p className="font-medium">Parul Tanwar</p>
                    <p className="text-dark_black/60 dark:text-white/60 text-sm font-medium">
                      Customer of Webxylon
                    </p>
                  </div>
                </motion.div>
              </div>
